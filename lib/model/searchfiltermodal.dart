...
TopSearchModal TopSearchModalFromJson(String str) =>
    TopSearchModal.fromJson(json.decode(str));

String TopSearchModalToJson(TopSearchModal data) => json.encode(data.toJson());

class TopSearchModal {
  TopSearchModal({
  ...
  factory TopSearchModal.fromJson(Map<String, dynamic> json) => TopSearchModal(

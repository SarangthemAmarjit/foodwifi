...
import 'package:foodwifi/logic/fetchbelowdata/cubit/fetch_restuarantlist_cubit.dart';
...
import 'package:foodwifi/refactor/lastlist.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  Widget build(BuildContext context) {
    ...
    final resdata = context.watch<FetchRestuarantlistCubit>().state;
                          ...
                          children: [
                            Text(
                              ...
                              style: GoogleFonts.kreon(
                                  color:
                                      const Color.fromARGB(255, 240, 17, 65)),
                            ),
                            Text(
                              'Welcome back!',
                              style: GoogleFonts.kreon(
                                  color:
                                      const Color.fromARGB(255, 247, 37, 22)),
                            ),
                          ],
                        ),
                        const CircleAvatar(
                ...
                child: SizedBox(
                  child: Column(
                    children: [
                      ...
                      LastList(allreslist: allreslist)
                    ],
                  ),
                ),
              )
